...
export const INITIAL_INTEGRATION_CONNECTORS: IntegrationConnector[] = [
  ...
  },
  {
    ...
    isSecretMasked: true,
    configFields: [
      { key: 'bot_username', label: 'Tên Bot Telegram', type: 'text', value: '@FreshDangKhoi_ErpBot', required: true },
      { key: 'bot_token', label: 'Bot Token (HTTP API)', type: 'password', value: '7392819401:AAH••••••••••••••••••••••••', masked: true, required: true },
      { key: 'admin_chat_id', label: 'Nhóm Chat Ban Quản Trị (Chat ID)', type: 'text', value: '-1002938491829', required: true },
      { key: 'warehouse_chat_id', label: 'Nhóm Chat Thủ Kho & Hậu Cần', type: 'text', value: '-1003948572019', required: true },
      { key: 'accounting_chat_id', label: 'Nhóm Chat Kế Toán & Thu Nợ', type: 'text', value: '-1004928193840', required: true }
    ]
  },
  {
    id: 'conn-zalo-oa',
...
export const INITIAL_WEBHOOKS: WebhookEndpoint[] = [
  ...
  },
  {
    ...
    targetUrl: 'https://api.telegram.org/bot7392819401/webhook',
