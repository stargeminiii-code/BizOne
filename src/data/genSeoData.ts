import { KeywordNode, KeywordEdge, GenSeoArticle, InternalLinkSuggestion, MascotConfig } from '../types';
...
export const INITIAL_KEYWORD_NODES: KeywordNode[] = [
  ...
  // ARTICLES (Under Cluster 1-1: Báo Giá Tôn Mạ Kẽm)
  {
    ...
    lastUpdated: '2026-08-20',
    status: 'published',
    suggestedArticleTitle: 'Bảng Báo Giá Tôn Hoa Sen Mạ Kẽm & Tôn Màu 2026 (Chiết Khấu Cao)',
    articleId: 'art-001',
    ranking: 1,
  ...
  },
  {
    ...
    lastUpdated: '2026-08-19',
    status: 'in_progress',
    suggestedArticleTitle: 'Đánh Giá So Sánh Tôn Đông Á và Tôn Phương Nam: Loại Nào Tốt Hơn?',
    articleId: 'art-002',
    ranking: 4,
    tags: ['Comparison']
  },
  ...
  // ARTICLES (Under Cluster 1-2: Tôn Cách Nhiệt)
  {
    ...
    lastUpdated: '2026-08-20',
    status: 'in_progress',
    suggestedArticleTitle: 'Báo Giá Tôn Xốp Cách Nhiệt 3 Lớp PU Chống Nóng Nhà Xưởng 2026',
    articleId: 'art-003',
    ranking: 6,
    tags: ['Factory']
  },
