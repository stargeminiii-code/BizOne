        ...
        <div>
          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
            <span className="px-3 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-blue-600 text-white shadow-xs">
              E-Commerce & Realtime Webhooks
            </span>
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-blue-400/20 text-blue-200 border border-blue-400/30 flex items-center gap-1">
          ...
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight flex items-center gap-3">
            ...
            <span>KẾT NỐI SÀN TMĐT, SKU MAPPING & API WEBHOOKS</span>
          </h1>
          <p className="text-xs sm:text-sm text-blue-200/90 mt-1 max-w-2xl">
            Cổng kết nối đồng bộ đa kênh Shopee, TikTok Shop, Website WooCommerce & Meta Fanpage. Tự động nhận Webhook đơn hàng, trừ tồn kho FIFO và đẩy tồn an toàn theo thời gian thực.
          </p>
        </div>
