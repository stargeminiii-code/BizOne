        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Quy hoạch đồ thị từ khóa Pillar-Cluster, viết bài SEO tự động, điều hướng liên kết nội bộ & phòng chống xung đột UI
            </p>
          </div>
        </div>
