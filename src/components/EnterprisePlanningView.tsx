        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <span className="bg-blue-500/20 text-blue-300 border border-blue-400/30 text-[11px] font-extrabold px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                Enterprise Planning & KPI Engine
              </span>
              <span className="text-xs text-slate-400 font-medium">BM01.QC11-EWH Standard</span>
            </div>
            <h1 className="text-2xl font-black tracking-tight text-white flex items-center gap-2">
              <span>HỆ THỐNG LẬP KẾ HOẠCH & QUẢN TRỊ KPI DOANH NGHIỆP</span>
            </h1>
            <p className="text-xs text-slate-300 max-w-3xl leading-relaxed">
              <span className="text-amber-300 font-bold">BizOne Executive Engine:</span> Đang ở đâu → Đang lệch ở đâu (GAP)
              → Vì sao lệch (Root Cause 14 tiêu chuẩn) → Ai phụ trách (PIC) → Cần làm gì (Action Plan) → Bao giờ xong → Kết quả đạt hay không.
            </p>
          </div>
