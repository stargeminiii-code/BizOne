      ...
      <div className="bg-gradient-to-r from-amber-900 via-amber-800 to-amber-950 text-white rounded-3xl p-6 shadow-xl border border-amber-700/50 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5 flex-wrap">
            <span className="px-3 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-amber-500 text-amber-950 shadow-xs">
              F&B & Menu Cafe
            </span>
            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-400/20 text-amber-200 border border-amber-400/30 flex items-center gap-1">
              ...
              Auto FIFO Recipe Deduction
            </span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight flex items-center gap-3">
            <Coffee className="w-8 h-8 text-amber-300" />
            <span>QUẢN LÝ ĐỒ UỐNG & ĐỊNH LƯỢNG RECIPE / BOM</span>
          </h1>
          <p className="text-xs sm:text-sm text-amber-200/90 mt-1 max-w-2xl">
            Quản lý Menu đồ uống pha chế, cấu trúc công thức Bill of Materials (BOM), tự động trừ kho nguyên liệu (Matcha, Cà phê, Sữa, Hoa quả) theo nguyên tắc FIFO khi bán hàng.
          </p>
        </div>
