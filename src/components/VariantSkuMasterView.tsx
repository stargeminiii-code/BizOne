      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-white p-5 rounded-3xl border border-slate-200 shadow-xs">
        <div>
          <div className="flex items-center gap-2 flex-wrap mb-1">
            <span className="px-2.5 py-0.5 bg-purple-100 text-purple-800 text-[10px] font-black rounded-full uppercase tracking-wider">
              Single Source of Truth
            </span>
            <span className="px-2.5 py-0.5 bg-blue-100 text-blue-800 text-[10px] font-bold rounded-full">
              Hệ Thống Master Data Toàn Diện
            </span>
            <span className="px-2.5 py-0.5 bg-emerald-100 text-emerald-800 text-[10px] font-bold rounded-full">
              Tự Động Đồng Bộ Kho & Dashboard
            </span>
          </div>
          <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
            <Layers3 className="w-6 h-6 text-purple-600" />
            <span>Định Nghĩa Variant SKU (Master Data)</span>
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">
            Liên kết chuẩn hóa: <strong>Sản Phẩm Cha (Product Code) → Biến Thể (Variant Master) → Variant SKU → Quy Cách/Combo</strong>
          </p>
        </div>
